        ...
        <Grid>
          <Grid.Row>
            <Grid.Column>
              ...
              <div>
                <p>
                  1. Choose your export options. By default all information
                  contained in the Contentful space will be exported, which may
                ...
                <br />
                <p>
                  2. Select the content type you want to export from the
                  Contentful space. You can only specify one value at a time. If
                  you need several content types, you will need to export them
                  separately.
                </p>
                <Dropdown
                ...
                <br />
                <p>
                  3. Filter by fields. As fields differ based on content type,
                  you can only select a field once you've selected the relevant
                  content type.
                </p>
                <Grid columns={3}>
                  <Grid.Row>
